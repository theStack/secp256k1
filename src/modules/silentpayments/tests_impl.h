...
void run_silentpayments_tests(void) {
    ...
    secp256k1_keypair xonly_keypair;
    ...
    CHECK(secp256k1_keypair_create(CTX, &xonly_keypair, input_privkeys_taproot));
    ...
    CHECK(secp256k1_silentpayments_send_create_shared_secret(CTX, shared_secret_sender,
        input_privkeys_plain, 1, &xonly_keypair, 1, outpoints_hash, &receiver_scan_pubkey_obj));
