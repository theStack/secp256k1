 ...
 * pointer such as secp256k1_nonce_function_default not take a context
 * object, they will not use the callback when called directly from user
 * code. (But they will use the callback when called from other library
 * functions that do take a context object, e.g., when
 * secp256k1_nonce_function_default is passed to secp256k1_ecdsa_sign.)
 *
 * Args:    ctx:             pointer to a context object.
