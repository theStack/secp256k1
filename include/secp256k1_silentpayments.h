 ...
 *  `secp256k1_silentpayments_label_serialize` and `secp256k1_silentpayments_label_parse`.
 */
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_silentpayments_label_parse(
    const secp256k1_context *ctx,
 ...
 */
SECP256K1_API int secp256k1_silentpayments_label_serialize(
    const secp256k1_context *ctx,
    unsigned char *out33,
